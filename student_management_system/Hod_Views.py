...
def UPDATE_STAFF(request):
    if request.method == "POST":
        ...
        staff.save()
        messages.success(request, 'Records updated succesffuly')
...
def ADD_SESSION(request):
    if request.method == "POST":
        ...
        session.save()
        messages.success(request, "Sessions are added succesfully")
...
def SAVE_STUDENT_NOTIFICATION(request):
    if request.method == "POST":
        ...
        messages.success(request, "Student notifications are sent")
